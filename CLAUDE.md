...
**Последний релиз: v0.5.9.** Хронология 0.5.x: 0.5.0 (сборка упала, E0716, не
...
**v0.6.0 (в работе, ветка `feature/v0.6.0-recording-ux`):** четыре UX-фичи.
...
4. **Копирование без Markdown.** `export::stripMarkdown`/`transcriptToPlain` +
   ...
   расшифровке. **Rust собран только локально-фронтом; жду CI + рантайм-тест.**
