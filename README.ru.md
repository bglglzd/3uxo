...
> **Пользовались Auris?** Memiro AI — новое имя Auris (с версии 0.10). Просто примите обновление: встречи, настройки и модели сохранятся, а старая программа «Auris» удалится сама.
