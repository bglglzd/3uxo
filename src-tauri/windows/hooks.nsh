...
;
; До 0.10 у приложения был другой productName. Установщик Tauri привязывает
; папку, ярлыки и запись «Программы и компоненты» к productName, поэтому
; установка Memiro AI встала бы рядом со старой. После установки тихо удаляем
; старую установку (файлы, ярлыки, запись в реестре). Данные пользователя
