    ...
    <div className="field mac-perms">
      ...
      <div className="perm-row">
        ...
        <div className="perm-text">
          ...
          <div className="hint">
            {system
              ? "Разрешено. Звук самого Auris в запись не попадает."
              : "Нужно разрешение «Запись экрана и системного звука». Без него пишется только микрофон. После включения перезапустите Auris."}
          </div>
        </div>
        {!system && (
          <button
