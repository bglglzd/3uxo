...
export interface AppSettings {
  ...
  /// Сквозные исправления: правка слова (фамилия/компания/термин) сразу во всех
  /// текстах встречи — расшифровке и ИИ-отчётах. Выкл — функция скрыта.
  fixEverywhere: boolean;
}
